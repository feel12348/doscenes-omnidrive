...
def train_detector(model,
    ...
    import inspect
    print(runner.load_checkpoint.__module__)
    print(inspect.getsource(runner.load_checkpoint))
    print("_______________________________")
    from ..debug_utils import ddp_breakpoint;ddp_breakpoint(target_rank=0)
    runner.run(data_loaders, cfg.workflow)
