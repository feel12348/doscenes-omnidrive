...
# DriveCode-style trajectory-number training without forcing doScenes-only data.
# This keeps the regular OmniDrive training setup and only changes the planning
# trajectory answer representation: waypoint numbers become <number_token> and
# are supervised by the continuous number regression head.
